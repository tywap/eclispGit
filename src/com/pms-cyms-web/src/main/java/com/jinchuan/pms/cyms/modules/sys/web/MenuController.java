...
//		}
	...
	public String tree(HttpServletRequest httpServletRequest) {
		if(httpServletRequest.getParameterMap().get("parentId")!=null){
			String[] menuTree=(String[])httpServletRequest.getParameterMap().get("parentId");
			if("1010".equals(menuTree[0])){
				return "redirect:" + adminPath + "/diagram/indexLeft";
			}
		}
