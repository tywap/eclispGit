...
import com.jinchuan.pms.pub.common.servlet.ValidateCodeServlet;
import com.jinchuan.pms.pub.common.utils.CookieUtils;
import com.jinchuan.pms.pub.common.utils.IdGen;
import com.jinchuan.pms.pub.common.utils.LoginUtils;
...
import com.jinchuan.pms.pub.modules.sys.security.FormAuthenticationFilter;
import com.jinchuan.pms.pub.modules.sys.security.SystemAuthorizingRealm.Principal;
...
public class LoginController extends BaseController {
	...
	@RequestMapping(value = "${adminPath}/first")
	public String first(HttpServletRequest request, HttpServletResponse response, Model model) {
		Principal principal = UserUtils.getPrincipal();
		PubShift psh = UserUtils.getShift();
		if (psh != null) {
			model.addAttribute("bcName", psh.getShiftName());
		}
		model.addAttribute("accountDate", UserUtils.getAccountDate());
		// 登录成功后，验证码计算器清零
	...
	public String index(HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		// UserUtils.getUser().getCompany().getName());
