    ...
    function createBox( $fileInput, file, webUploader ) {
        ...
        var li = '<li id="fileBox_'+file_id+'" class="diyUploadHover"> \
					<div class="viewThumb">\
					    ...
					    <span class="diyLeft">封面</span>\
					    <p class="diyControl"><span onclick="setCover(this)" class="cover">设为封面</span><span class="diyCancel"><i></i></span></p>\
					</div> \
				</li>';
        ...
        $('.diyControl').on('click','.cover',function(){
        	$(this).parent('.diyControl').siblings('.diyLeft').css({'display':'inline-block'});
        	console.log($(this).parents('.diyUploadHover').siblings().find('.diyLeft').html())
        	$(this).parents('.diyUploadHover').siblings().children('.viewThumb').children('.diyLeft').css({'display':'none'});
        })
        //生成预览缩略图;
