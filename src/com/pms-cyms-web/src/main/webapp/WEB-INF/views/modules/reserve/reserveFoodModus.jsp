...
<head>
    ...
    <script type="text/javascript">
    	...
    	function submitBtn(){
			...
			var params = "foodId=${foodId}&cookValues="+cookValues+"&cookValuesTemp="+cookValuesTemp+"&tableNo=${tableNo}";
			loadAjax("${ctx}/reserve/saveFoodModus", params, function(result) {
...
<body>
	...
	<div class="tab-pane active" id="tab0">
		<jsp:include page="../order/modus.jsp"></jsp:include>
	</div>
