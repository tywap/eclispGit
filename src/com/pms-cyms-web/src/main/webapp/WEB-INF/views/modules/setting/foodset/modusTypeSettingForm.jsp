...
<body>
	<form:form id="inputForm" modelAttribute="sysBusiConfig"
		action="${ctx}/setting/modusSetting/save" method="post"
		class="form-horizontal">
		<input name="id" id="id" value="${modusList.id }" type="text"
			htmlescape="false" maxlength="64" style="display: none;">
