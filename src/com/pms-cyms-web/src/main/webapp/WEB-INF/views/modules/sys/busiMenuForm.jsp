...
<body>
	...
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/busimenu/">菜单列表</a></li>
		<li class="active"><a href="${ctx}/sys/busimenu/form?id=${menu.id}&parent.id=${menu.parent.id}">菜单<shiro:hasPermission name="sys:menu:edit">${not empty menu.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:menu:edit">查看</shiro:lacksPermission></a></li>
	</ul>
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/busimenu/save" method="post" class="form-horizontal breadcrumb form-search">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label-xs">上级菜单：</label>
			<div class="controls">
                <sys:treeselect id="menu" name="parent.id" value="${menu.parent.id}" labelName="parent.name" labelValue="${menu.parent.name}"
					title="菜单" url="/sys/busimenu/treeData" extId="${menu.id}" cssClass="required"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label-xs">链接：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label-xs">目标：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label-xs">图标：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label-xs">可见：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label-xs">权限标识：</label>
			<div class="controls">
