...
<script type="text/javascript">
	...
	function getOrdConsumesByOrdId(){
		var reserveId = '${id}';
		var params = {reserveId:reserveId};
		loadAjax("${ctx}/reserve/getReserveConsume",params,function(result){
			if(result.retCode=="000000"){
				...
				for(var i=0;i<list.length;i++){
					var obj = list[i];
					html += "<tr name='consumeItem' data-status='"+obj.status+"'>"+
						"<input type='hidden' name='obj' value='"+JSON.stringify(obj)+"'>"+
						"<td><input type='checkbox' checked name='itemCheckBoxBtn' class='weeks' id='"+obj.id+"' value='"+obj.status+"' data-id='"+obj.feeId+"'/></td>"+
