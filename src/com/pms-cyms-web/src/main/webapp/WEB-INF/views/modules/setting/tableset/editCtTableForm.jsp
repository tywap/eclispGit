	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#submitBtn").bind("click",function(){
				...
				loadAjax("${ctx}/setting/ctTable/editTable",
...
<body>
	...
	<input type="hidden" id="storeId" name="storeId"  value="${ctTable.storeId}">
	<input type="hidden" id="status" name="status"  value="${ctTable.status}">
	<input type="hidden" id="id" name="id"  value="${ctTable.id}">
	<input type="hidden" id="rentId" name="rentId"  value="${ctTable.rentId}">
			    	...
			    	<div class="panel-body">
						<div class="row">
							<div class="span">
								...
								<input type="text" id="no" name="no" htmlEscape="false" class="input-medium6 digits required" value="${ctTable.no}"/>
								</div>
							</div>
							<div class="span">
								<div class="control-group">
									...
									<div class="controls">
									<input type="text" id="name" name="name" htmlEscape="false" class="input-medium6 digits required" value="${ctTable.name}"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<select path="roomType" id="floor" name ="floor" class="input-medium6 digits required">
										...
										<c:forEach items="${foorlList}" var="foorlList">
											<option value="${foorlList.paramKey}"<c:if test="${foorlList.paramKey==ctTable.floor}">selected="selected"</c:if> >${foorlList.name}</option>
									...
									<div class="controls">
										<select path="roomFeature" id="typeId" name="typeId"
											...
											<c:forEach items="${ctTableTypeList}" var="ctTableTypeList">
												<option value="${ctTableTypeList.id}" <c:if test="${ctTableTypeList.id==ctTable.typeId}">selected="selected"</c:if>>${ctTableTypeList.name}</option>
						...
						<div class="row">
							...
							<div class="span">
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="normalNum" name="normalNum" value="${ctTable.normalNum}" />
									</div>
								</div>
							</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="maxNum" name="maxNum" value="${ctTable.maxNum}"/>
									</div>
								</div>
							</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" id="minNum" name="minNum" value="${ctTable.minNum}" />
									</div>
								</div>
							</div>
							...
							<div class="span">
								<div class="control-group">
									...
									<div class="controls">
									<input type="text" id="sort" name="sort" htmlEscape="false" class="input-medium6 digits required" value="${ctTable.sort}"/>
									</div>
								</div>
					...
					<div class="row">
							<div class="span12">
								<div class="control-group">
									...
									<div class="controls">
										 <textarea  id="remarks" name="remarks" value="${ctTable.remarks}"></textarea>
									</div>
								</div>
							</div>
						</div>
